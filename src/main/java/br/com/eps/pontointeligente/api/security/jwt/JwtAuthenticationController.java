...
public class JwtAuthenticationController {
	 ...
	 */
	@PostMapping
	public ResponseEntity<Response<JwtTokenDto>> gerarTokenJwt(
			@Valid @RequestBody JwtAuthenticationDto authenticationDto, BindingResult result)
			throws AuthenticationException {
		Response<JwtTokenDto> response = new Response<JwtTokenDto>();
		...
		response.setData(new JwtTokenDto(token));
	...
	public ResponseEntity<Response<JwtTokenDto>> gerarRefreshTokenJwt(HttpServletRequest request) {
		...
		response.setData(new JwtTokenDto(refreshedToken));
		return ResponseEntity.ok(response);
	}
